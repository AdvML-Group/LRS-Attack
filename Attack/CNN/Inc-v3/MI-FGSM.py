...
parser.add_argument('--input_dir', type=str, default='../../../dataset/images',
                    help='Input directory with images.')
parser.add_argument('--output_dir', type=str, default='../../outputs/incv3-MI-lrs', help='Source Models.')
...
def main():
    ...
    for images, images_ID, gt_cpu in tqdm(data_loader):
        gt = gt_cpu.cuda()
        images = images.cuda()
        adv_img = graph(model, images, gt, opt)
