"""Implementation of DI-FGSM attack."""
import os
import torch
...
parser.add_argument('--input_dir', type=str, default='../../../dataset/images',
                    help='Input directory with images.')
parser.add_argument('--output_dir', type=str, default='../../../outputs/incv3_DI_lrs', help='Source Models.')
...
parser.add_argument("--compression_rate", type=float, default=0.9)
parser.add_argument("--rank_ratio", type=float, default=0.1)
parser.add_argument("--num_iters_oats", type=int, default=10)
...
def graph(model, x, gt):
    ...
    for i in range(num_iter):
        ...
        output = multi_lrs_inv3(model[1], model[0](DI(adv_images)))
