"""Implementation of pure TI-FGSM attack."""
import os
import torch
...
parser.add_argument('--input_dir', type=str, default='../../../dataset/images',
                    help='Input directory with images.')
parser.add_argument('--output_dir', type=str, default='../../../outputs/inv3-TI-FGSM-lrs', help='Source Models.')
...
def graph(model, x, gt):
    ...
    for i in range(num_iter):
        ...
        # TI-FGSM: Apply kernel convolution to gradients
