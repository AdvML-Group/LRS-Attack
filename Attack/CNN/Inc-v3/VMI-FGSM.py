...
parser.add_argument('--output_dir', type=str, default='../../../outputs/incv3-VT-MI-lrs', help='Source Models.')
...
parser.add_argument("--compression_rate", type=float, default=0.4)
...
def graph(model ,x, gt):
    ...
    for i in range(num_iter):
        ...
        for _ in range(N):
            ...
            output = multi_lrs_inv3(model[1], model[0](neighbor_images))
            cost = F.cross_entropy(output, gt)
